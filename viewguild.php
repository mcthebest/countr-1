    ...
    <div class="main-panel" id="main-panel">
        ...
        <div class="panel-header panel-header-lg">
            ...
            if ($detect->isMobile()) {
                ...
                echo '<h3 style="color:white; text-align: center">Overview</h3>';
            }
            ?>
        </div>
        <div class="content">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card card-chart">
                        <div class="card-header">
                            <h4 class="card-title">Last Count</h4>
                        </div>
                        <div class="card-body">
                            <h3><?php echo $response->count ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="card card-chart">
                        <div class="card-header">
                            <h4 class="card-title">Member Count</h4>
                        </div>
                        <div class="card-body">
                            <h3><?php echo $response->guild->members ?></h3>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
